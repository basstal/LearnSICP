...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        attr_keyword = message[len(magic_word):].strip()
        if hasattr(self.obj, attr_keyword):
            return getattr(self.obj, attr_keyword)(*args)
        else:
            return f'Thanks for asking, but I know not how to {attr_keyword}.'
