...
def if_this_not_that(i_list, this):
    ...
    5
    """
    for t in [(lambda v: v if v > this else "that")(v) for v in i_list]:
        print(t)
...
def closer_city(lat, lon, city1, city2):
    ...
    'Bucharest'
    """
    compare_city = make_city('temp', lat, lon)
    return get_name(city1) if distance(compare_city, city1) < distance(compare_city, city2) else get_name(city2)
