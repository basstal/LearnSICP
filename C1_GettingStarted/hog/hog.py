...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    return score0 > 1 and score1 > 1 and (score1 % score0 == 0
                                          or score0 % score1 == 0)
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    def say(score0, score1, previous_high, previous_score):
        score = score0 if who == 0 else score1
        gain_score = score - previous_score
        if previous_high < gain_score:
            print(
                f"{gain_score} point{'s' if score > 1 else ''}! That's the biggest gain yet for Player {who}"
            )
            previous_high = gain_score
        return lambda score0, score1: say(score0, score1, previous_high, score)

    return lambda score0, score1: say(score0, score1, previous_high,
                                      previous_score)
    # END PROBLEM 7
